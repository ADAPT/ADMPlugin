...
namespace ADMPlugin
{
    ...
    public class ProtobufSerializer : IProtobufSerializer
    {
        ...
        RuntimeTypeModel GetProtobufModel()
        {
            ...
            model[typeof(Summary)].Add(688, "ContainerUseIds");
            ...
            model[typeof(HitchPoint)].Add(633, "RefPoint");
            ...
            model[typeof(Connector)].Add(653, "DeviceConfigurationId");
            ...
            model[typeof(ActiveIngredient)].Add(752, "ModesOfAction");
            ...
            model[typeof(Product)].AddSubType(784, typeof(CropVariety));
            model[typeof(CropVariety)].Add(785, "CropId");
            model[typeof(CropVariety)].Add(786, "TraitIds");
            model[typeof(CropVariety)].Add(787, "GeneticallyEnhanced");
            ...
            model[typeof(Product)].AddSubType(794, typeof(FertilizerProduct));
            model[typeof(FertilizerProduct)].Add(795, "IsManure");
            ...
            model[typeof(ValueType)].AddSubType(801, typeof(Enum));
            model[typeof(Enum)].AddSubType(802, typeof(ModeOfAction));
            ...
            model[typeof(Product)].AddSubType(807, typeof(ProductMix));
            model[typeof(ProductMix)].Add(808, "TotalQuantity");
            model[typeof(ProductMix)].Add(809, "IsTemporary");
            model[typeof(ProductMix)].Add(810, "IsHotMix");
