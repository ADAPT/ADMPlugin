...
namespace ADMPlugin
{
    ...
    public class ProtobufSerializer : IProtobufSerializer
    {
        ...
        RuntimeTypeModel GetProtobufModel()
        {
            ...
            model[typeof(Equipment)].Add(655, "Id");
            model[typeof(Equipment)].Add(656, "Description");
            model[typeof(Equipment)].Add(657, "SerialNumber");
            model[typeof(Equipment)].Add(658, "ManufacturerId");
            model[typeof(Equipment)].Add(659, "BrandId");
            model[typeof(Equipment)].Add(660, "SeriesId");
            model[typeof(Equipment)].Add(661, "ContextItems");
            ...
            model[typeof(EquipmentConfiguration)].Add(667, "ContainerEquipmentAllocations");
