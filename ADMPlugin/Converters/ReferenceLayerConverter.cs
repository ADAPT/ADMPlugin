...
{
  public class ReferenceLayerConverter : IReferenceLayerConverter
  {
    public SerializableReferenceLayer ConvertToSerializableReferenceLayer(ReferenceLayer referenceLayer)
    {
      if (referenceLayer.GetType() == typeof(RasterReferenceLayer))
      {
        ...
        return new SerializableReferenceLayer
        {
          ...
          StringValues = GetStringValues(rasterReferenceLayer),
          EnumerationMemberValues = GetEnumeratedValues(rasterReferenceLayer),
          NumericValueValues = GetNumericValues(rasterReferenceLayer)
        };
      }
