...
namespace AgGateway.ADAPT.ADMPlugin.Protobuf.V1.ReferenceLayers
{
  public static class RasterDataNumericRepresentationType
  {
    public static void Configure(RuntimeTypeModel model)
    {
      ...
      type.AddField(465, nameof(AgGateway.ADAPT.ApplicationDataModel.ReferenceLayers.RasterData<AgGateway.ADAPT.ApplicationDataModel.Representations.NumericRepresentation, AgGateway.ADAPT.ApplicationDataModel.Representations.NumericValue>.Representation));
    }
  }
}
