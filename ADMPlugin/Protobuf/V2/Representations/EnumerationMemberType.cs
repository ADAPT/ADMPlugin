...
namespace AgGateway.ADAPT.ADMPlugin.Protobuf.V2.Representations
{
  public static class EnumerationMemberType
  {
    public static void Configure(RuntimeTypeModel model)
    {
      ...
      type.AddField(1, nameof(AgGateway.ADAPT.ApplicationDataModel.Representations.EnumerationMember.Code));
      type.AddField(2, nameof(AgGateway.ADAPT.ApplicationDataModel.Representations.EnumerationMember.Value));
    }
  }
}
