...
namespace AgGateway.ADAPT.ADMPlugin.Protobuf.V2.Documents
{
  public static class WorkRecordType
  {
    public static void Configure(RuntimeTypeModel model)
    {
      ...
      type.AddField(1, nameof(AgGateway.ADAPT.ApplicationDataModel.Documents.WorkRecord.LoggedDataIds));
      type.AddField(2, nameof(AgGateway.ADAPT.ApplicationDataModel.Documents.WorkRecord.SummariesIds));
    }
  }
}
